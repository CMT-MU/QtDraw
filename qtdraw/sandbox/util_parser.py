...
from qtdraw.sandbox.pyvista_widget_setting import DIGIT, default_preference, default_status
from qtdraw.sandbox.element import element_color
from qtdraw.sandbox.pyvista_widget_setting import widget_detail as detail
from qtdraw.sandbox.data_group import _data_no_space_group
from qtdraw.sandbox.vesta import parse_vesta, create_structure_vesta
